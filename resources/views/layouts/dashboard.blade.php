        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    <!-- Dashboard -->
                    <li
                        class="menu-item {{ config('app.url') . '/input-data-page' === request()->url() ? 'active' : '' }}">
                        <a href="{{ url('input-data-page') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-home-circle"></i>
                            <div data-i18n="Analytics">Data Masuk</div>
                        </a>
                    </li>
                    <li
                        class="menu-item {{ config('app.url') . '/penanggung-jawab' === request()->url() ? 'active' : '' }}">
                        <a href="{{ url('penanggung-jawab') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-home-circle"></i>
                            <div data-i18n="Analytics">Penanggung Jawab</div>
                        </a>
                    </li>
                    <li class="menu-header small text-uppercase"><span class="menu-header-text">Sudah
                            Dikonfirmasi</span>
                    </li>
                    <li
                        class="menu-item {{ config('app.url') . '/purposes/keluar-page' === request()->url() ? 'active' : '' }}">
                        <a href="{{ url('purposes/keluar-page') }}" class="menu-link">
                            <span class="menu-icon tf-icons material-symbols-outlined">
                                sort_by_alpha
                            </span>
                            <div data-i18n="Analytics">Semua Data</div>
                        </a>
                    </li>
